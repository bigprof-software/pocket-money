<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'transactions' table. 
	...
	*/
	 ...
	 *     $data['kid'], $data['date'], $data['amount'], $data['description']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['kid'], $data['date'], $data['amount'], $data['description'], $data['balance']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kid'], $data['date'], $data['amount'], $data['description']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['kid'], $data['date'], $data['amount'], $data['description'], $data['balance']
