<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'kids' table. 
	...
	*/
	...
	function kids_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function kids_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function kids_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function kids_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function kids_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function kids_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function kids_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function kids_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function kids_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function kids_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function kids_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function kids_batch_actions(&$args) {
