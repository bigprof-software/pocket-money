...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once("{$currDir}/hooks/kids.php");
	include_once("{$currDir}/kids_dml.php");
	...
	$x->ColCaption = ['Name', 'Pocket money', 'Photo', 'Last balance', ];
	$x->ColFieldName = ['name', 'pocket_money', 'photo', 'last_balance', ];
	$x->ColNumber  = [2, 3, 4, 5, ];
