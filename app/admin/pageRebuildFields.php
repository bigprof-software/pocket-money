	...
	*/
	...
	$schema = array(
		'kids' => array(
			...
			'name' => array('appgini' => 'VARCHAR(40) not null unique '),
			'pocket_money' => array('appgini' => 'DECIMAL(10,2) null '),
			'photo' => array('appgini' => 'VARCHAR(40) null '),
			'last_balance' => array('appgini' => 'DECIMAL(10,2) null '),
		),
		'transactions' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'kid' => array('appgini' => 'INT unsigned null '),
			'date' => array('appgini' => 'DATE null '),
			'amount' => array('appgini' => 'DOUBLE(10,2) null '),
			'description' => array('appgini' => 'TEXT null '),
			'balance' => array('appgini' => 'DOUBLE(10,2) null '),
		),
	);
